...
# Create a sample sales data DataFrame (replace this with your actual data)
...
pivot_table = sales_data.pivot_table(index=['Region', 'Manager', 'SalesMan'], values='Sale_amt', aggfunc='sum')
